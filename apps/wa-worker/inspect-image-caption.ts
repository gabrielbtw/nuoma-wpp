...
(async () => {
  ...
  const imagePath =
    "/Users/gabrielbraga/Projetos/nuoma-wpp/storage/uploads/media/temp/image/shared/0548e59b5399-Captura_de_Tela_2026-03-11_a_s_23.29.20.png";
  const context = await chromium.launchPersistentContext(
    "/Users/gabrielbraga/Projetos/nuoma-wpp/storage/chromium-profile/whatsapp",
    {
      channel: "chrome",
      headless: false,
      viewport: null,
  ...
  await attach.click();
  await page
    .getByText(/fotos e vídeos|fotos e videos/i)
    .first()
    .click();
  ...
  await page.screenshot({
    path: "/Users/gabrielbraga/Projetos/nuoma-wpp/storage/screenshots/image-caption-debug.png",
    fullPage: true,
  });
  await context.close();
})();
