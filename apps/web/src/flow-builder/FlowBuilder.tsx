    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-xs leading-relaxed text-fg-dim">
            Valida telefone, duplicatas e linhas antes de criar qualquer destinatário.
          </p>
        </div>
    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-xs leading-relaxed text-fg-dim">
            Atribuição determinística por destinatário; a variante B pode trocar o texto do primeiro
            Step.
          </p>
        </div>
