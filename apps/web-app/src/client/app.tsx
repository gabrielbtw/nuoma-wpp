...
const ContactTabLabPage = lazy(() =>
  import("./pages/contact-tab-lab").then((module) => ({ default: module.ContactTabLabPage })),
);
const AutomationsPage = lazy(() =>
  import("./pages/automations").then((module) => ({ default: module.AutomationsPage })),
);
const CampaignsPage = lazy(() =>
  import("./pages/campaigns").then((module) => ({ default: module.CampaignsPage })),
);
const TrendsPage = lazy(() =>
  import("./pages/trends").then((module) => ({ default: module.TrendsPage })),
);
...
const ChatbotPage = lazy(() =>
  import("./pages/chatbot").then((module) => ({ default: module.ChatbotPage })),
);
const AttendantsPage = lazy(() =>
  import("./pages/attendants").then((module) => ({ default: module.AttendantsPage })),
);
    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 xl:grid-cols-3">
        {Array.from({ length: 3 }).map((_, index) => (
          <div
            key={index}
            className="h-48 rounded-[1.5rem] border border-white/8 bg-white/[0.03]"
          />
        ))}
      </div>
    </div>
