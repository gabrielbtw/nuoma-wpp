        ...
        <Card className="overflow-hidden">
          ...
          <CardContent className="p-0">
            <div className="max-h-[580px] divide-y divide-white/6 overflow-y-auto custom-scrollbar">
              ...
              {!query.isLoading && events.length === 0 ? <div className="px-6 py-12 text-sm text-slate-400">Nenhum evento encontrado.</div> : null}
            </div>
            <Pager
              page={eventsPage}
        ...
        <Card className="overflow-hidden">
          ...
          <CardContent className="p-0">
            <div className="max-h-[580px] divide-y divide-white/6 overflow-y-auto custom-scrollbar">
              ...
              {!query.isLoading && jobs.length === 0 ? <div className="px-6 py-12 text-sm text-slate-400">Nenhum job encontrado.</div> : null}
            </div>
            <Pager
              page={jobsPage}
              hasNext={hasNextJobs}
