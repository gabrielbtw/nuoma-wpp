...
const envSchema = z.object({
  ...
  IG_OPEN_ON_STARTUP: booleanish.default(false),
  WA_SYNC_INTERVAL_SEC: z.coerce.number().int().min(10).default(15),
  IG_SYNC_INTERVAL_SEC: z.coerce.number().int().min(10).default(120),
  IG_ENABLE_INBOX_SYNC: booleanish.default(false),
  WA_SYNC_CHATS_LIMIT: z.coerce.number().int().min(1).max(99999).default(100),
  WA_SYNC_MESSAGES_LIMIT: z.coerce.number().int().min(5).max(200).default(30),
  WA_SYNC_SCROLL_COUNT: z.coerce.number().int().min(0).max(20).default(0),
  WA_SYNC_BUDGET_MS: z.coerce.number().int().min(10_000).max(600_000).default(120_000),
  WA_SYNC_FORWARD_BUDGET_MS: z.coerce.number().int().min(10_000).max(600_000).default(180_000),
  WA_SYNC_BACKFILL_BUDGET_MS: z.coerce.number().int().min(10_000).max(600_000).default(120_000),
  WA_SYNC_BACKFILL_SCROLL_CAP: z.coerce.number().int().min(1).max(500).default(50),
  WA_LIVE_WINDOW_HOURS: z.coerce.number().int().min(1).max(48).default(4),
  ...
  IG_SYNC_SCROLL_PASSES: z.coerce.number().int().min(0).default(0),
  ...
  SCHEDULER_INTERVAL_SEC: z.coerce.number().int().min(5).default(60),
  ...
  AI_PROVIDER: z.enum(["auto", "openai", "local", "none"]).default("auto"),
  AI_COST_APPROVED: z.string().default(""),
