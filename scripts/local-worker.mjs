...
const workerEnv = {
  ...
  WA_SEND_ALLOWED_PHONES: process.env.WA_SEND_ALLOWED_PHONES ?? "",
  WA_SEND_ALLOWED_PHONE: process.env.WA_SEND_ALLOWED_PHONE ?? "5531982066263",
  IG_SEND_ALLOWED_HANDLES: process.env.IG_SEND_ALLOWED_HANDLES ?? "",
  IG_SEND_CONFIRMATION_TIMEOUT_MS: process.env.IG_SEND_CONFIRMATION_TIMEOUT_MS ?? "15000",
  WORKER_INSTAGRAM_SYNC_ENABLED: process.env.WORKER_INSTAGRAM_SYNC_ENABLED ?? "false",
  WORKER_INSTAGRAM_SYNC_INTERVAL_MS: process.env.WORKER_INSTAGRAM_SYNC_INTERVAL_MS ?? "60000",
  WORKER_INSTAGRAM_SYNC_THREAD_LIMIT: process.env.WORKER_INSTAGRAM_SYNC_THREAD_LIMIT ?? "5",
  WORKER_INSTAGRAM_SYNC_MESSAGE_LIMIT: process.env.WORKER_INSTAGRAM_SYNC_MESSAGE_LIMIT ?? "20",
  WORKER_INSTAGRAM_SYNC_SCROLL_PASSES: process.env.WORKER_INSTAGRAM_SYNC_SCROLL_PASSES ?? "6",
  IG_WEB_URL: process.env.IG_WEB_URL ?? "https://www.instagram.com/direct/inbox/",
  ...(process.env.M303_BEFORE_SEND_SCREENSHOT_PATH
    ? { M303_BEFORE_SEND_SCREENSHOT_PATH: process.env.M303_BEFORE_SEND_SCREENSHOT_PATH }
    : {}),
};
